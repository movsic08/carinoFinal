            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="example" class="table table-striped table-bordered table-hover text-center">
                    ...
                    <tbody>
                        @foreach($approvedAppointments as $appointmentData)
                            <tr>
                                ...
                                <td>
                                    <div>
                                      <a href="{{url('emailview', $appointmentData->id)}}" class="btn btn-info btn-sm">
                                        <i class="fas fa-envelope" style="font-size: 0.9rem;"></i> Send Email
                                    </a>                                            
                                    </div>
                                </td>
                            </tr>
