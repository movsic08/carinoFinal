                  ...
                  <tbody>
                    @foreach ($clients as $index => $client)
                        <tr class="align-middle">
                            ...
                            <td>
                              <a href="{{ route('edit-client', ['id' => $client->id]) }}" class="btn btn-xs btn-success">
                                  <i class="bx bx-edit"></i> Update
                              </a>
                              <a href="{{ route('view-client-profile', ['encrypted_id' => Crypt::encrypt($client->id)]) }}" class="btn btn-xs btn-primary">
                                  <i class='bx bx-file'></i> View
                              </a>
                              <a href="{{ route('delete-client', ['encrypted_id' => Crypt::encrypt($client->id)]) }}" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure you want to delete this client?')">
