        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    ...
                    <div class="ms-auto">
                        <div class="btn-group">
                            <a class="btn btn-sm add-assessment-btn" href="{{ route('add-assessment-record', ['id' => $client->id]) }}">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex flex-column align-items-center text-center">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <a href="{{ route('admin.view.client.personal', ['id' => $client->id]) }}" class="btn btn-outline-secondary btn-sm" id="viewProfileBtn">
                                                    <i class="fa-solid fa-user fa-2xs"></i> View Profile
                                                </a>
                                                
                                                <a href="{{ route('add-user-account', ['clientId' => $client->id]) }}" class="btn btn-outline-secondary btn-sm">
                                                    <i class="fa-solid fa-address-card fs-2xs"></i> Register
                                                </a>

                                                <a href="#" class="btn btn-outline-secondary btn-sm">
                                                    <i class="fa-solid fa-address-card fs-2xs"></i> Account
                                                </a>
                                        ...
                                        <div class="tab-content" id="myTabContent" style="height: 350px; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                            <div class="tab-pane fade show active" id="medical-info" role="tabpanel" aria-labelledby="medical-info-tab">
                                               ...
                                               <!-- Display health evaluation information for the client -->
                                                @include('admin.clients.medrecord.med-info')
                                                @else
                                            ...
                                            <div class="tab-pane fade" id="assessment" role="tabpanel" aria-labelledby="assessment-tab">
                                                @if ($client->assessmentRecords && $client->assessmentRecords->isNotEmpty())
                                                    @include('admin.clients.medrecord.latest')
                                                @else
                                                    <div class="text-center info-box">
