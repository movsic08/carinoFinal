                    ...
                    @foreach ($clientsWithAssessments as $index => $client)
                        <tr class="align-middle">
                            ...
                            <td class="text-center">                        
                              <a href="{{ route('view-client-assessments', ['id' => $client->id]) }}" class="btn btn-xs btn-info">
                                  <i class="fas fa-eye small-icon" style="font-size: 1em;"></i> View Assessments
                              </a>
                              <a href="{{ route('add-assessment-record', ['id' => $client->id]) }}" class="btn btn-xs btn-primary">
