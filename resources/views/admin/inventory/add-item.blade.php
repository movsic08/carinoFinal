        ...
        <div class="col-md-6">
          ...
          <form action="{{ route('admin.inventory.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mb-1">
              ...
              <input type="text" name="item_code" class="form-control" id="item_code" required>
            </div>
            ...
            <div class="form-group mb-1">
              ...
              <input type="number" name="stocks" class="form-control" id="stocks" required>
            </div>
        ...
        <div class="col-md-6">
          ...
          <div id="imagePreview"></div>
            ...
            <div class="d-flex justify-content-end">
              <button type="submit" class="btn btn-primary btn-sm"><i class="fa-regular fa-floppy-disk fa-2xs"></i> Add Item</button>
          </div>
