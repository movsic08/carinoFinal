			...
			<div class="topbar d-flex align-items-center">
				<nav class="navbar navbar-expand gap-3">
						...
						<ul class="navbar-nav align-items-center gap-1">
							...
							<li class="nav-item dropdown dropdown-add">
								...
								<div class="dropdown-menu dropdown-menu-end" style="width: fit-content; padding: 10px; margin: 5px;">
									...
									<a class="dropdown-item d-flex align-items-center" href="javascript:;" style="font-size: 15px;">
										<i class='bx bx-xs bx-user-circle' style="margin-right: 10px;"></i> Employee
									</a>
									<a class="dropdown-item d-flex align-items-center" href="javascript:;" style="font-size: 15px;">
										<i class='bx bx-xs bx-calendar' style="margin-right: 10px;"></i> Event
									</a>
								</div>
							</li>
							...
							<li class="nav-item dark-mode d-none d-sm-flex">
								<a id="darkModeToggle" class="nav-link dark-mode-icon" href="javascript:;"><i class='bx bx-moon'></i></a>
							</li>
					...
					<div class="user-box dropdown px-3">
						<a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="{{ url('staff/profile') }}" role="button" data-bs-toggle="dropdown" aria-expanded="false">
						<img src="{{ (!empty($profileData->photo)) ? url('upload/staff_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" class="user-img border border-dark border-2 rounded-circle" alt="user avatar">						
						<div class="user-info">
						...
						<ul class="dropdown-menu p-0 dropdown-menu-end">
							<li>
								...
								<div class="d-flex flex-column align-items-center border-bottom px-4 py-3">
									<img src="{{ (!empty($profileData->photo)) ? url('upload/staff_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="Profile Picture" class="img-thumbnail rounded-circle" style="width: 100px; height: 100px;" >
							...
							<ul class="list-unstyled p-1 mt-1 mb-1">
								...
								<li>
									<a class="dropdown-item d-flex align-items-center" href="{{ route('staff.change.password') }}">
