              ...
              <table id="example" class="table table-striped table-bordered table-hover text-center">
                <thead class="table-dark">
                  <tr>
                      ...
                      <th scope="col" class="text-center align-middle text-nowrap"> Full Name </th>
                      <th scope="col" class="text-center align-middle text-nowrap"> Client Code </th>
                      <th scope="col" class="text-center align-middle text-nowrap"> Method Accepted </th>
                      <th scope="col" class="text-center align-middle text-nowrap"> Actions </th>
                  </tr>
              </thead>
                <tbody>
                    @foreach ($clientsWithAssessments as $index => $client)
                        <tr class="align-middle">
                            ...
                            <td class="text-center">                        
                              <a href="{{ route('staff-view-client-assessments', ['id' => $client->id]) }}" class="btn btn-xs btn-info">
                                  <i class="fas fa-eye small-icon" style="font-size: 1em;"></i> View Assessments
                              </a>
                              <a href="{{ route('staff-add-assessment-record', ['id' => $client->id]) }}" class="btn btn-xs btn-primary">
                                  <i class="fas fa-file-circle-plus small-icon" style="font-size: 1em;"></i> Add Assessment
                              </a>
                          </td>                          
                        </tr>
                    @endforeach
