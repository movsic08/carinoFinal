                        ...
                        @foreach ($assessmentRecords as $index => $assessmentRecord)
                            <tr class="align-middle">
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('staff-delete-assessment', ['id' => $assessmentRecord->id]) }}" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure you want to soft delete this assessment record?')">
