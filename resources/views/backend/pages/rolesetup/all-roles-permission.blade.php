    ...
    <div class="page-wrapper">
      <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <a href="{{ route('role.permission.store') }}" class="btn btn-sm" style="background-color: #164863; color: #fff;">
                    Add Role Permission <i class='bx bxs-user-plus'></i>
                </a>
              </div>
          ...
          <div class="card">
            <div class="card-body">
              <div class="table-responsive">
                <h6 class="card-title text-uppercase">All Roles Permission</h6>
                <hr>
                <table id="example" class="table table-striped table-bordered table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.edit.roles', $item->id) }}" class="btn btn-sm btn-warning mx-2">Edit</a>
                                <a href="{{ route('admin.delete.roles', $item->id) }}" class="btn btn-sm btn-danger">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
