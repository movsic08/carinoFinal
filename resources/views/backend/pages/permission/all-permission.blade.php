    ...
    <div class="page-wrapper">
      <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <a href="{{ route('add.permission') }}" class="btn btn-sm" style="background-color: #164863; color: #fff;">
                    Add Permission <i class='bx bxs-user-plus'></i>
                </a>
              </div>
          ...
          <div class="card">
            <div class="card-body">
              <div class="table-responsive">
                <h6 class="card-title text-uppercase">Permission All</h6>
                <hr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('edit.permission', $item->id) }}" class="btn btn-sm btn-warning mx-2">Edit</a>
                                <a href="{{ route('delete.permission', $item->id) }}" class="btn btn-sm btn-danger">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
