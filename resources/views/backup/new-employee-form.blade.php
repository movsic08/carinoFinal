		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="ps-3">
				 ...
				 <!-- <h6 class="mb-0 text uppercase">Add New Employee</h6> -->
				<hr/>
				<div class="card">
					<div class="card-body p-4">
						<div class="card-body">
							...
							@endif
							<form method="POST" action="{{ url('/admin/upload_employee') }}" enctype="multipart/form-data" class="row g-3">
								@csrf
								<div class="col-md-12">
									<label for="input25" class="form-label">First Name</label>
									<div class="input-group">
										<span class="input-group-text"><i class='bx bx-user'></i></span>
										<input type="text" id="input25" name="firstname" class="form-control" required placeholder="Enter First Name">
									</div>
								</div>
								<div class="col-md-12">
									...
									<div class="input-group">
										<span class="input-group-text"><i class='bx bx-user'></i></span>
										<input type="text" id="input25" name "middlename" class="form-control" placeholder="Enter Middle Name">
									</div>
								</div>
								<div class="col-md-12">
									...
									<div class="input-group">
										<span class="input-group-text"><i class='bx bx-user'></i></span>
										<input type="text" id="input26" name="lastname" class="form-control" required placeholder="Enter Last Name">
									</div>
								</div>
								<div class="col-md-12">
									...
									<div class="input-group">
										...
										<input type="text" id="input28" name="number" class="form-control" required placeholder="Enter Phone Number">
									</div>
								</div>
								<div class="col-md-12">
									...
									<div class="input-group">
										...
										<input type="email" id="input27" name="email" class="form-control" required placeholder="Enter Email Address">
									</div>
								</div>
								<div class="col-md-12">
								...
								<div class="col-md-12">
									<div class="d-md-flex d-grid align-items-center gap-3">
										<button type="submit" class="btn btn-primary">Upload Employee</button>
